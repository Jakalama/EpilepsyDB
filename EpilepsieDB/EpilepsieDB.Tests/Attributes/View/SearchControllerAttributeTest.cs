...
namespace EpilepsieDB.Tests.Attributes.View
{
    public class SearchControllerAttributeTest : AbstractTest
    {
        ...
        {
            Assert.True(Helper.Helper.TypeHasAttribute<ControllerAttribute>(typeof(SearchController)));
        }
        ...
        public void Has_CorrectApiExplorerSettings()
        {
            ...
            bool actual = Helper.Helper.TypeHasAttributeValue<SearchController, ApiExplorerSettingsAttribute, bool>(attr => attr.IgnoreApi);
