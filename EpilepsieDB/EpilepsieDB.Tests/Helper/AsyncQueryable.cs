...
namespace EpilepsieDB.Tests.Helper
{
    ...
    public static class QueryableExtensions
    {
        ...
        {
            return new AsyncQueryable<T>(input);
        }

    }

    public class AsyncQueryable<T> : IQueryable<T>, IAsyncEnumerable<T>, IEnumerable<T>, IEnumerable
    {
        private readonly List<T> _innerCollection;
        public AsyncQueryable(IEnumerable<T> innerCollection)
        {
