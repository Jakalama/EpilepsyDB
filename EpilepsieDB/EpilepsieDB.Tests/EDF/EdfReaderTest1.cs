...
namespace EpilepsieDB.Tests.EDF
{
    ...
    public class EdfReaderTest1 : AbstractTest
    {
        private readonly string testFile;

        public EdfReaderTest1(ITestOutputHelper output) : base(output)
        {
        ...
        {
            // set
            string expected = "Startdate 12-AUG-2009 X X BCI2000";
